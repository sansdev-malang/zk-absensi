            ...
            <div class="bg-indigo-50 border border-indigo-100 rounded-2xl p-5 shadow-sm flex items-start gap-4">
                ...
                <div>
                    ...
                    <ul class="list-disc list-inside text-indigo-800 text-sm space-y-1">
                        ...
                        <li><strong>Tips:</strong> Jika semua karyawan di perusahaan Anda memiliki aturan bonus hadir yang sama persis, Anda cukup membuat <strong>1 Skema Global</strong> saja untuk ditautkan ke semua Shift.</li>
                    </ul>
                </div>
            </div>
                            ...
                            @forelse($schemes as $scheme)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-right space-x-3">
                                        ...
                                        <a href="{{ route('bonus-schemes.edit', $scheme->id) }}" class="inline-flex items-center gap-1 text-blue-600 hover:text-blue-900 font-medium text-sm transition">
